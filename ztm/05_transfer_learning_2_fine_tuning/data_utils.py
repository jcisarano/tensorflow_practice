...
LOCAL_DATA_PATH_ALL: str = os.path.join("datasets", "images/10_food_classes_all_data")
...
TRAIN_DATA_PATH_ALL: str = os.path.join(LOCAL_DATA_PATH_ALL, "train")
TEST_DATA_PATH_ALL: str = os.path.join(LOCAL_DATA_PATH_ALL, "test")
